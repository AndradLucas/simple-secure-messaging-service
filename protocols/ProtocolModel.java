...
/** Defines a basic model to protocols.
 * This class aims to simplify the Protocol implementation providing a standard protocol implementation.
 * The Socked run the protocol as following:
 * <PRE>
 *
 * while (true) {
 ...
 *         } else {
 *             // Send abort message if enabled.
 *         }
 *     } else if (protocol.nextStep() == Protocol.RECEIVE_STEP) {
 *         msg = this.readSequence(inputStream);
